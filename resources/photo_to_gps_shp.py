...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.photo_to_gps_shp_prompt = PushButton(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.photo_to_gps_shp_prompt.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/images/message.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.photo_to_gps_shp_prompt.setIcon(icon)
        self.photo_to_gps_shp_prompt.setIconSize(QtCore.QSize(20, 20))
        self.photo_to_gps_shp_prompt.setObjectName("photo_to_gps_shp_prompt")
        self.verticalLayout_5.addWidget(self.photo_to_gps_shp_prompt)
        ...
        self.photo_to_gps_shp_filepath_line = LineEdit(self.frame_2)
        self.photo_to_gps_shp_filepath_line.setMinimumSize(QtCore.QSize(500, 40))
        self.photo_to_gps_shp_filepath_line.setObjectName("photo_to_gps_shp_filepath_line")
        self.horizontalLayout.addWidget(self.photo_to_gps_shp_filepath_line)
        self.photo_to_gps_shp_filepath_btn = PrimaryPushButton(self.frame_2)
        self.photo_to_gps_shp_filepath_btn.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.photo_to_gps_shp_filepath_btn.setFont(font)
        self.photo_to_gps_shp_filepath_btn.setStyleSheet("PushButton, ToolButton, ToggleButton, ToggleToolButton {\n"
"    color: black;\n"
...
"}\n"
"")
        self.photo_to_gps_shp_filepath_btn.setObjectName("photo_to_gps_shp_filepath_btn")
        self.horizontalLayout.addWidget(self.photo_to_gps_shp_filepath_btn)
        self.verticalLayout_4.addLayout(self.horizontalLayout)
        self.photo_to_gps_shp_process_btn = PrimaryPushButton(self.frame_2)
        self.photo_to_gps_shp_process_btn.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.photo_to_gps_shp_process_btn.setFont(font)
        self.photo_to_gps_shp_process_btn.setStyleSheet("PushButton, ToolButton, ToggleButton, ToggleToolButton {\n"
"    color: black;\n"
"    background: rgba(255, 255, 255, 0.7);\n"
"    border: 1px solid rgba(0, 0, 0, 0.073);\n"
"    border-bottom: 1px solid rgba(0, 0, 0, 0.183);\n"
...
"}\n"
"")
        self.photo_to_gps_shp_process_btn.setObjectName("photo_to_gps_shp_process_btn")
        self.verticalLayout_4.addWidget(self.photo_to_gps_shp_process_btn)
    ...
    def retranslateUi(self, Form):
        ...
        self.TitleLabel_3.setText(_translate("Form", "提取照片的地理信息"))
        self.photo_to_gps_shp_prompt.setText(_translate("Form", "用前必看(请点击)"))
        self.photo_to_gps_shp_filepath_btn.setText(_translate("Form", "获取文件夹"))
        self.photo_to_gps_shp_process_btn.setText(_translate("Form", "开始"))
