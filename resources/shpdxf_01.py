...
# Form implementation generated from reading ui file 'G:\code\shp2dxf_pyqt\resources\shpdxf_01.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.shp2dxf_origin_prompt = PushButton(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.shp2dxf_origin_prompt.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/images/message.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.shp2dxf_origin_prompt.setIcon(icon)
        self.shp2dxf_origin_prompt.setIconSize(QtCore.QSize(20, 20))
        self.shp2dxf_origin_prompt.setObjectName("shp2dxf_origin_prompt")
        self.verticalLayout_5.addWidget(self.shp2dxf_origin_prompt)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.TitleLabel_3.setText(_translate("Form", "SHP文件转换为DXF文件(保存所有的字段到同一个DXF文件)"))
        self.shp2dxf_origin_prompt.setText(_translate("Form", "用前必看(请点击)"))
