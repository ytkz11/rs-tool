...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.shp2kml_prompt = PushButton(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.shp2kml_prompt.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/images/message.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.shp2kml_prompt.setIcon(icon)
        self.shp2kml_prompt.setIconSize(QtCore.QSize(20, 20))
        self.shp2kml_prompt.setObjectName("shp2kml_prompt")
        self.verticalLayout_5.addWidget(self.shp2kml_prompt)
        ...
        self.shp2kml_filepath_line = LineEdit(self.frame_2)
        self.shp2kml_filepath_line.setMinimumSize(QtCore.QSize(500, 40))
        self.shp2kml_filepath_line.setObjectName("shp2kml_filepath_line")
        self.horizontalLayout.addWidget(self.shp2kml_filepath_line)
        self.shp2kml_filepath_btn = PrimaryPushButton(self.frame_2)
        self.shp2kml_filepath_btn.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.shp2kml_filepath_btn.setFont(font)
        self.shp2kml_filepath_btn.setStyleSheet("PushButton, ToolButton, ToggleButton, ToggleToolButton {\n"
"    color: black;\n"
...
"}\n"
"")
        self.shp2kml_filepath_btn.setObjectName("shp2kml_filepath_btn")
        self.horizontalLayout.addWidget(self.shp2kml_filepath_btn)
        self.verticalLayout_4.addLayout(self.horizontalLayout)
        self.shp2kml_process_btn = PrimaryPushButton(self.frame_2)
        self.shp2kml_process_btn.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.shp2kml_process_btn.setFont(font)
        self.shp2kml_process_btn.setStyleSheet("PushButton, ToolButton, ToggleButton, ToggleToolButton {\n"
"    color: black;\n"
"    background: rgba(255, 255, 255, 0.7);\n"
"    border: 1px solid rgba(0, 0, 0, 0.073);\n"
"    border-bottom: 1px solid rgba(0, 0, 0, 0.183);\n"
...
"}\n"
"")
        self.shp2kml_process_btn.setObjectName("shp2kml_process_btn")
        self.verticalLayout_4.addWidget(self.shp2kml_process_btn)
    ...
    def retranslateUi(self, Form):
        ...
        self.TitleLabel_3.setText(_translate("Form", "SHP文件转换为KML"))
        self.shp2kml_prompt.setText(_translate("Form", "用前必看(请点击)"))
        self.shp2kml_filepath_btn.setText(_translate("Form", "获取路径"))
        self.shp2kml_process_btn.setText(_translate("Form", "开始转换"))
