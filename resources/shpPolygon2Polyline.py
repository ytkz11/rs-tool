...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Polygon2Polyline_prompt = PushButton(self.frame_2)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.Polygon2Polyline_prompt.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/images/message.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Polygon2Polyline_prompt.setIcon(icon)
        self.Polygon2Polyline_prompt.setIconSize(QtCore.QSize(20, 20))
        self.Polygon2Polyline_prompt.setObjectName("Polygon2Polyline_prompt")
        self.verticalLayout_5.addWidget(self.Polygon2Polyline_prompt)
        ...
        self.Polygon2Polyline_filepath_line = LineEdit(self.frame_2)
        self.Polygon2Polyline_filepath_line.setMinimumSize(QtCore.QSize(500, 40))
        self.Polygon2Polyline_filepath_line.setObjectName("Polygon2Polyline_filepath_line")
        self.horizontalLayout.addWidget(self.Polygon2Polyline_filepath_line)
        self.Polygon2Polyline_filepath_btn = PrimaryPushButton(self.frame_2)
        self.Polygon2Polyline_filepath_btn.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.Polygon2Polyline_filepath_btn.setFont(font)
        self.Polygon2Polyline_filepath_btn.setStyleSheet("PushButton, ToolButton, ToggleButton, ToggleToolButton {\n"
"    color: black;\n"
...
"}\n"
"")
        self.Polygon2Polyline_filepath_btn.setObjectName("Polygon2Polyline_filepath_btn")
        self.horizontalLayout.addWidget(self.Polygon2Polyline_filepath_btn)
        self.verticalLayout_4.addLayout(self.horizontalLayout)
        self.Polygon2Polyline_process_btn = PrimaryPushButton(self.frame_2)
        self.Polygon2Polyline_process_btn.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.Polygon2Polyline_process_btn.setFont(font)
        self.Polygon2Polyline_process_btn.setStyleSheet("PushButton, ToolButton, ToggleButton, ToggleToolButton {\n"
"    color: black;\n"
"    background: rgba(255, 255, 255, 0.7);\n"
"    border: 1px solid rgba(0, 0, 0, 0.073);\n"
"    border-bottom: 1px solid rgba(0, 0, 0, 0.183);\n"
...
"}\n"
"")
        self.Polygon2Polyline_process_btn.setObjectName("Polygon2Polyline_process_btn")
        self.verticalLayout_4.addWidget(self.Polygon2Polyline_process_btn)
    ...
    def retranslateUi(self, Form):
        ...
        self.TitleLabel_3.setText(_translate("Form", "SHP文件-面矢量转换为线矢量"))
        self.Polygon2Polyline_prompt.setText(_translate("Form", "用前必看(请点击)"))
        self.Polygon2Polyline_filepath_btn.setText(_translate("Form", "获取路径"))
        self.Polygon2Polyline_process_btn.setText(_translate("Form", "开始转换"))
