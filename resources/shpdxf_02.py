...
# Form implementation generated from reading ui file 'G:\code\shp2dxf_pyqt\resources\shpdxf_02.ui'
#
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.TitleLabel_3.setText(_translate("Form", "SHP文件转换为DXF文件(按字段分层)"))
